 ...
 */
class Duplicate_VLAN_IDs_RADIUS_returns_VLAN_name  extends MTMTest
{
	...
	public function MyExecute()
	{
        ...
        */ 
		...
		system("banner ivalnid");	
		echo $iVlanID;
		echo $this->framework->GetTestbed()->GetId();
        ...
        $oUser->updateEgressVlan($sTestNpName1); 
		
		$oUser=new User($sTestUser2,$sTestUser2,"Enabled");
        $oUser->updateEgressVlan($sTestNpName2); 
